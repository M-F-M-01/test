...
logo=(f'''\x1b[1;91m 
      ...
      $$/      $$/         $$/            $$/      $$/ 
\033[1;37m==============================================================
\033[1;91m[] DEVELOPER :  KING_MALANG\033[1;97m & \033[1;91mKING_FAISAL
\033[1;91m[] FACEBOOK  :  FOR THIS SORRY
\033[1;91m[] WHATSAPP  :  +93784214671
\033[1;91m[] TYPE      :  RANDOM
\033[1;91m[] TOOLS     : \033[1;92m Trail
\033[1;91m[] VIRSION   :  \033[1;91m0.7
\033[1;37m==============================================================''')
...
def main_menu():
    os.system("clear")
    print(logo)
    print(f"YOUR DATA FUCKED BY KING_MALANG ")   
    print(f"ENTER TO EXIT")
    lin3()
    cp =input('>>>>>>>>>😒 ')
    if cp=="1":file()
    else:
